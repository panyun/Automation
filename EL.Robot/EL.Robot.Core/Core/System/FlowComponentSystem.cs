...
namespace EL.Robot.Core
{
    ...
    {
        public static async EL.Async.ELTask Main(this FlowComponent self)
        {
        ...
        public static object GetVariablesValue(Variable variable)
        {
            ...
            var type = variable.InitType.ToLower().Trim();
            if (string.IsNullOrWhiteSpace(variable.InitType)) return default;

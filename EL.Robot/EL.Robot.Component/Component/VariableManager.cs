...
namespace EL.Robot.Component
{
	public static class VariableSystem
	{
		...
		public static ValueInfo SelectVariable(string defalutValue = "") => new()
		{
			DisplayName = "选择值",
			Value = defalutValue,
		...
		public static List<ValueInfo> InputOrSelectOrUpValues() => new() { InputVariable(), SelectVariable(), UpVariable() };
		//上一条Node

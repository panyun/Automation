...
namespace EL.Capturing
{
    ...
    public class MouseOverlay : OverlayBase
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            var cursorBitmap = CaptureComponentHelper.CaptureCursor(ref outputPoint);
            // Early exit
            ...
            var scale = CaptureComponentHelper.GetScale(CaptureImage.OriginalBounds, CaptureImage.Settings);
            if (scale != 1)
            {

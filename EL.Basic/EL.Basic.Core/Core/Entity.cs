...
namespace EL
{
    ...
    public abstract class ELObject : ISupportInitialize, IDisposable
    {
    ...
    public partial class Entity : ELObject
    {
        [IgnoreDataMember]
        ...
        public Entity Domain
        {
            ...
            private set
            {
                ...
                if (preDomain == null)
                {
                    this.InstanceId = (long)IdGenerater.Instance.GenerateInstanceId();
        ...
        public virtual Entity GetComponent(string name)
        {
            if (this.components == null)
                return null;
            Entity component;
            component = this.components.FirstOrDefault(x => x.Key.Name == name).Value;
            return component;
        }
        ...
        public K AddComponent<K>(bool isFromPool = false) where K : Entity, new()
        {
            ...
            if (this.components != null && this.components.ContainsKey(type))
            {
                return this.components[type] as K;
                // throw new Exception($"entity already has component: {type.FullName}");
            }

...
namespace EL.WindowsAPI
{
    ...
    /// </summary>
    public static class Win32Fallback
    {
        ...
        public static class Win32CalendarMessages
        {
        ...
        public static class Win32CalendarStyles
        {
            public const uint MCS_MULTISELECT = 2;
        }

        public static class DateTimePicker32Messages
        {
            public const uint DTM_GETSYSTEMTIME = 0x1001;
            public const uint DTM_SETSYSTEMTIME = 0x1002;
        }

        public static class DateTimePicker32Constants
        {
        ...
        //public static bool GetTextWin32(AutomationElement automationElement, out string textOut)
        //{
        ...
        public static bool SetTextWin32(IntPtr elementHwnd, string text)
        {
            if (elementHwnd != IntPtr.Zero)
            {

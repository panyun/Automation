...
namespace ET
{
    ...
    public static class ActorMessageSenderComponentSystem
    {
        ...
        public static async ETTask<ResponseType> Call<ResponseType>(
            this ActorMessageSenderComponent self, 
            long actorId, 
            IActorRequest request, 
            bool needException=true) where ResponseType : IActorResponse
        {
           return (ResponseType)await Call(self, actorId, request, needException);
        }
        ...
        public static async ETTask<ResponseType> Call<ResponseType>(
            ...
            bool needException = true) where ResponseType : IActorResponse
        {
            return (ResponseType)await Call(self, actorId, rpcId, memoryStream, needException);
        }

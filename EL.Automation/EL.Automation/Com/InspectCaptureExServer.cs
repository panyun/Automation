...
namespace Automation.Com
{
    ...
    {
        public static string CapturesFilePath { get; set; } = @"../Captures";
        public static string FileLoggerPath { get; }
    }
    /// <summary>
    /// 桌面句柄截图
    /// </summary>
    public class InspectCaptureExServer
    {

        /// <summary>
        /// 
        /// </summary>
        public InspectCaptureExServer()
        {
            //创建
        ...
        public CaptureInfoResponse GetCaptureInfo(int x, int y)
        {
            ...
            try
            {
                ...
                //CaptureServerHelper.MostTop(element);
